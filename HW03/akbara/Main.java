package akbara;
import akbara.sift.Sifter;
import akbara.vehicle.FordF350;
import akbara.vehicle.Vehicle;
...
public class Main {
   ...
   public static void main(String[ ] args) {
      ...
      vehicles[0] = new akbara.vehicle.HondaFit("white"); // I specified this this way just
                                                            // to show it can be done. Doing it
                                                            // like the other packages is fine.
      vehicles[1] = new FordF350("green");
      vehicles[2] = new akbara.vehicle.HondaFit("red");
      ...
      Sifter s = new Sifter( );
      akbara.vehicle.HondaFit hondas[ ] = s.getFits(vehicles);
